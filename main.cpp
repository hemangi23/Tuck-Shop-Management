...
{
    system("CLS");
    gotoxy(40,1);cout<<"TUCK SHOP MANAGEMENT";
...
{
    system("CLS");
    gotoxy(40,1);cout<<"TUCK SHOP MANAGEMENT SYSYTEM";
    gotoxy(40,2);cout<<"-----------------"<<endl<<endl;
...
void store::price()
{
    ...
    cout<<endl;
    gotoxy(40,0);
    cout<<"TUCK SHOP MANAGEMENT SYSYTEM";
    gotoxy(40,2);
    cout<<"-----------------"<<endl<<endl;
...
class login
{
  public:
      ...
      void homepage()
      {
          system("CLS");
          gotoxy(40,1);
          cout<<"WELCOME TO TUCK SHOP MANAGEMENT SYSYTEM";
          gotoxy(40,2);
          cout<<"----------------------------"<<endl<<endl;
          cout<<"     1. LOGIN"<<endl;
...
int main()
{
    system("TUCK SHOP MANAGEMENT SYSYTEM");
    system("color 71");
    login l;
    l.homepage();
    return 0;
